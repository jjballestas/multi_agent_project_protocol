# AGENTS.md - Shared source of truth for missing_dependency
...
`Validate adopted_profiles case missing_dependency.`

Description:

`Golden validation fixture for adopted_profiles: missing_dependency.`
