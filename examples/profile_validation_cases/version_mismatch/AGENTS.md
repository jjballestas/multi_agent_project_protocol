# AGENTS.md - Shared source of truth for version_mismatch
...
`Validate adopted_profiles case version_mismatch.`

Description:

`Golden validation fixture for adopted_profiles: version_mismatch.`
