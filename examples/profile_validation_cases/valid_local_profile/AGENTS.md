# AGENTS.md - Shared source of truth for valid_local_profile
...
`Validate adopted_profiles case valid_local_profile.`

Description:

`Golden validation fixture for adopted_profiles: valid_local_profile.`
