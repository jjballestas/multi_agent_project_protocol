# AGENTS.md - Shared source of truth for protocol_incompatible
...
`Validate adopted_profiles case protocol_incompatible.`

Description:

`Golden validation fixture for adopted_profiles: protocol_incompatible.`
