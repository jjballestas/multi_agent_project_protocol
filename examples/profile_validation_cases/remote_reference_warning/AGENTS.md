# AGENTS.md - Shared source of truth for remote_reference_warning
...
`Validate adopted_profiles case remote_reference_warning.`

Description:

`Golden validation fixture for adopted_profiles: remote_reference_warning.`
