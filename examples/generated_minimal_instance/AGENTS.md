# AGENTS.md - Shared source of truth for generated_minimal_instance
...
>
> Last updated: 2026-07-24. Maintainer: Claude + operador humano.
...
`Exercise the scaffolding script with a minimal valid protocol instance.`

Description:

`Temporary generated instance used to verify the scaffolding.`

## 2. Current Phase and Scope

- Phase id: `P0`
- Phase name: `Initial setup`
- Phase goal: `Create a valid initial protocol state.`
...
- `Analista`: Independent analyst / checker.
...
| `Analista` | Adversarial checker | Independently challenges the maker's evidence and verifies acceptance criteria | Does not implement or ratify its own reviewed work |
