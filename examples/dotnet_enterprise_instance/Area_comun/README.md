...
This folder contains the shared, auditable state for `dotnet_enterprise_instance`.
...
- Do not change `No secrets committed. dotnet_enterprise profile boundaries apply when adopted.` without a decision.
