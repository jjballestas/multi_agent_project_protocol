...
$PromptPath = Join-Path $RuntimeDir "analista_mailbox_cron.prompt.txt"
...
1. Ancla SIEMPRE en canonico (el commit de producto y el HEAD del protocolo que cita la instruccion), NO en
   working tree.
2. CLON LIMPIO: clona el repo de producto (D:/Agentes/Zeus/Zeus-protocol) a un tmp, checkout del commit citado,
