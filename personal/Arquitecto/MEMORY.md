...
- **PROXIMO:** al veredicto 0221: si GO-PROMOVER-OFF -> promover la DECISION-Engram OFF (asignar DECISION-00XX accepted via submit_intent decision-intent; capability OFF; PATCH sigue SPEC hasta que Codex implemente+pruebe). Si NO-GO -> aplicar correcciones. Actualizar reporte pipeline.html (hora+dataset) + memoria.
