...
- **PIPELINE al cierre de sesion:** **DONE:** 0223 (vista Instanciar F1), 0225 (Arquitecto-cron), 0226 (WS1 branding), **0228 (WS5 alta-Analista + wrapper new_instance 4 participantes)**. **review_approved:** 0224 (redactor). **in_review (esperando veredicto Analista, RE-DISPARADOS):** 0222 (stats, remediacion timeout), 0227 (boundary F1, remediacion guard). **proposed (backlog):** 0229 [WS3 branding], 0230 [WS2 bootstrapper], 0231 [WS4 backend+peones sandbox], 0232 [WS3.5 instalador], 0234 [WS10 runbooks], **0235 [INFRA exec-lease hardening de crons]**. (0233 WS7 e2e diferida: owner Analista, registrar tras cerrar 0228 -- ya cerrada, se puede registrar.)
