...
intake:
  ...
  verification_cmd: "python scripts/memory/test_memory_db.py && python scripts/check_falsification_contracts.py --root . --inventory && python scripts/validate_collaboration_state.py --root . && python scripts/scan_domain_neutrality.py --root ."
  scope_routes:
