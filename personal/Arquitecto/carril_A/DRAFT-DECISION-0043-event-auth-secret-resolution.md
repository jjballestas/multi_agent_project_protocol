...
# DECISION-0043 (DRAFT) - Resolucion del secreto HMAC de event_auth fuera del repo

> DRAFT del Arquitecto. NO promovida. El operador eligio "construir el cargador primero" (2026-06-19)
> tras el hallazgo de que el piloto de #4 esta bloqueado por falta de un home fuera-del-repo para el
> secreto HMAC. Esta decision autoriza la capacidad minima que cierra ese hueco; entra por SPEC-0082 +
> TASK-0120 + revision maker!=checker + GO del operador. NO enciende #4.
