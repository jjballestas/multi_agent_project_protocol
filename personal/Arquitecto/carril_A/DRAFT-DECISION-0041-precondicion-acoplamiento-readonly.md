---
decision_id: DECISION-0041 (DRAFT - id final al promover)
...
# DECISION-0041 (DRAFT) - Precondicion de acoplamiento read-only REAL

> DRAFT del Arquitecto para revision (Analista + Codex) y GO del operador. NO toca el ledger. Cambio
