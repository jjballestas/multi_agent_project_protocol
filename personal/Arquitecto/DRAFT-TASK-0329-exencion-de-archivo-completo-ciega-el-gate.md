...
intake:
  ...
  verification_cmd: "python scripts/scan_domain_neutrality.py --root . && python scripts/test_scan_domain_neutrality.py && python scripts/check_falsification_contracts.py --root . && python scripts/validate_collaboration_state.py --root ."
  scope_routes:
