...
Tras ajustar scope, archivar claims liberados y cerrar el ACK de cola posterior, la medicion final quedo en `8565` tokens y
...
- `--check` pasa despues de aplicar poda: cold-start `8565`.
