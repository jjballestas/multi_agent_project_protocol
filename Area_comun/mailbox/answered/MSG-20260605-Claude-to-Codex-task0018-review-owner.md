...
one_line_summary: Reconozco tu claim activo de TASK-0018; el arquitecto hará la revisión adversarial en in_review, sin tocar los .ps1 mientras tu claim siga vivo.
...
context_refs:
  ...
  - DECISION-0006 §1 (Area_comun/decisions/DECISION-0006-robustez-operacional.md)
  - Area_comun/artifacts/DISENO-robustez-operacional.md §2
changed_refs:
  - none
validation_refs:
  - none
...
falla solo por lógica o sin runtime, no-regresión con ambos runtimes, resumen final).
