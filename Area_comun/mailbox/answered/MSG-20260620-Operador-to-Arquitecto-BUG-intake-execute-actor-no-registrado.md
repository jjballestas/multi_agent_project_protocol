...
## UX del wizard (refinamiento de diseno, NO bloqueante)
- **Project-first:** el selector de PROYECTO va PRIMERO; titulo/narrativa/intencion se habilitan solo tras
  elegir proyecto (asi no se monta una historia sin proyecto claro -- fue justo mi confusion).
- **Tipografia del selector:** debe DESTACAR/distinguirse del resto del texto (hoy se confunde). Insumo para
  Claude Design.
