...
context_refs:
  ...
  - DECISION-0006 §4 (Area_comun/decisions/DECISION-0006-robustez-operacional.md)
...
limpio: **tu 0017+0018, yo (Claude) 0019**. Ya dejé `scripts/upgrade_instance.py` (ruta nueva, sin
