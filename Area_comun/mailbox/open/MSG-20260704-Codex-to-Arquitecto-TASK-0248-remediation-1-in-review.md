...
artifacts: "Handoff Area_comun/handoffs/HANDOFF-TASK-0248-codex-to-arquitecto-2.md. Protocol skills/codegen-triage.skill.md, skills/skills.config.json, .claude/skills/codegen-triage/SKILL.md. Product commit af790be fix: add Nova web test gate."
