---
message_id: MSG-20260728-Arquitecto-to-Codex-ACTION-remediar-TASK-0298-v2
from: Arquitecto
to: Codex
type: ACTION
status: open
...
one_line_summary: "RE-RUTEO remediacion 0298 (in_progress, tras cerrarse 0300): 3 bloqueantes B1(PII framing)/B2(guarda anti-spawn fail-open)/B3(test.skip) + SLIP-4/5; falsabilidad exigida; re-juicio de la Analista (ya arreglada) en clon limpio antes del cierre."
---

# ACTION - remediar TASK-0298 (bridge observacion-tail) - RE-RUTEO tras cerrar 0300

Hora local: 2026-07-28 ~15:40. Se cerro TASK-0300 (harness endurecido, ratificado) y se arreglo el
hang del review headless de la Analista (ExecTimeout per-agente: la Analista vuelve a 3600). Ahora
re-ruteo la remediacion de 0298, que estaba en HOLD. 0298 esta in_progress sin claim: reclamalo y remedia.

## Lo que de verdad importa (los 3 bloqueantes REALES del NO-GO de la Analista)
...
1. **B1 es el grave (AC5, fuga de PII en el caso normal).** El bridge publica bytes crudos por poll sin
   ...
   correo + NIT salen EN CLARO por SSE y al audit. Frame por lineas: emite solo hasta el ultimo salto,
