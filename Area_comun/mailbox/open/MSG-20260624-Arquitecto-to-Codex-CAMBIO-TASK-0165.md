...
El Analista (lo ratifico): (1) mailbox_send genera un MSG con requires_response invalido (rr=true sin question -> el
validador lo rechaza); ponlo requires_response:false (prompt operator_directive normal) o con un question coherente.
