...
- **Endpoints del front:** abrir/estado, enviar mensaje, **stream** (p.ej. SSE), finalizar la sesion. Read-only
  sobre el trabajo.
...
- **Runtime-only** (espejo DECISION-0057): solo lanza/relanza/finaliza; nunca identidad/llaves/registro/config;
  **orden de cese del operador respetada** (la sesion termina de verdad).
- **Sesion unica** (anti-colision): jamas dos sesiones del Arquitecto en simultaneo.
