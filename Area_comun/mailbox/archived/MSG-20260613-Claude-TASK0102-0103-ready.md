...
requested_action: Operador puede empujar ambas a Codex; Codex autonomo puede reclamar si esta habilitado.
context_refs:
...
# GO - TASK-0102 y TASK-0103 ready para ejecucion

**Promocion a ready completada.**

## Dependencia resuelta

**TASK-0101** (prev_hash encadenado, SPEC-0076) esta ahora `done` (ratificado adversarial en esta sesion).
Ambas tareas pueden avanzar sin bloqueos.

## TASK-0102 - Firma por agente (DECISION-0029 pieza 2b)

- **SPEC:** SPEC-0071 (504 lineas, completada)
- **Deliverables:** 
  ...
  - 10 golden cases (off-by-default, sig valida, falsificacion, agent desconocido, predicado incompleto, revisor, prev_hash+sig, determinismo, legacy, enable post-hoc)
- **Aceptance criteria:** AC1-AC10 (flag, schema, backend, verificacion, sin secretos, encoding)
- **Status:** ready -> Codex puede reclamar

## TASK-0103 - Anclaje externo periodico (DECISION-0029 pieza 2c)

- **SPEC:** SPEC-0072 (497 lineas, completada)
- **Deliverables:**
  - Evento `chain.anchor` publica HEAD digest periodicamente en medio externo
...
Operador decide si:
1. Empuja ambas a Codex manualmente (si operador_push esta habilitado)
2. Espera a que Codex autonomo las reclame (si autonomy esta habilitado)
3. Planifica ejecucion secuencial (0102 antes de 0103, ambas dependen de 0101 ya done)
