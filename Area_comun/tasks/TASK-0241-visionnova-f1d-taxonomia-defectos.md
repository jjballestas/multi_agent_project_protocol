...
intake:
  ...
  acceptance:
    ...
    - Escala de severidad CRITICAL / WARNING-real / WARNING-theoretical / SUGGESTION adoptada con la regla del uso normal (si el uso normal lo dispara, es real) y reflejada en el prompt del checker (Analista).
  ...
  scope_routes:
    ...
    - personal/analista/
  out_of_scope:
    - No toca validadores ni gates automaticos (la taxonomia es doc mas prompt del checker, no codigo).
