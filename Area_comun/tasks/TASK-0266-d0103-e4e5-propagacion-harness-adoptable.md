...
del Operador). Secuencia: arranca tras el CIERRE de TASK-0257 (comparte
scripts/new_instance.py con su scope); puede correr en paralelo con TASK-0258 (rutas
disjuntas), manteniendo GO de a una.
