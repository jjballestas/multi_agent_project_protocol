...
# DECISION-0042 - Mailbox claims file-scoped (anti-deadlock del canal)

> ACCEPTED por el operador (2026-06-19, "eso no puede pasar") tras un incidente real: un claim de
> coordinacion con scope dir-level sobre `Area_comun/mailbox/` bloqueo la respuesta de Codex en el canal.
> Addendum a DECISION-0020 (anti-colision). Aditivo. La parte de enforcement (guard) es implementacion de
> Codex (TASK-0119).
