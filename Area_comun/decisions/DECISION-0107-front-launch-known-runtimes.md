...
> escritura/runtime (CLAUDE.md regla 2 / AGENTS.md s4). Codigo SOLO en Zeus-protocol (producto); core neutral.
> NO toca el config pinned (#4 epoca 1.14.0), ni INTENT_TYPES, ni genesis/keys, ni el agent_registry.
...
## Implementacion
Via SDD: SPEC-0113 (autora el Arquitecto) + TASK-0311 (maker Codex, checker Analista+Arquitecto), off-by-default,
