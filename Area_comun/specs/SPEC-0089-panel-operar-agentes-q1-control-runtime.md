# SPEC-0089 - Panel "Operar Agentes" (Q1): control de runtime (vivo/dormido + activar/detener) + despertar al destino

- **Estado:** draft (registrada en el ledger; pendiente GO ejecutado a Codex). Maker: Codex. Checker: Arquitecto + pasada Analista (no-bypass / no-autoridad / allowlist).
