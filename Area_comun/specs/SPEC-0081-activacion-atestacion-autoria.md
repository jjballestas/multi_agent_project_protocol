...
# SPEC-0081 - Activacion grado-tesis de la atestacion de autoria (#4)
...
|-------------|------|------|-------------------|
| Provisioning (public_keys + event_auth.keys + anchor remote) sin secretos | TASK-0117 | smoke provisioning + scan secretos + verify firma | AC1 |
| Salud del instrumento >=99% (NO seguridad; denominador del log) | TASK-0117 | attestation_health_cases | AC2 |
| Seguridad: prueba negativa binaria, 6 vectores, golden/vector | TASK-0117 | 6 goldens negativos A1/A2 (exit-code) | AC3 |
| Evento de atestacion estructurado (esquema, no scan_encoding) | TASK-0117 | inspeccion de esquema | AC4 |
| Rollback reversible | TASK-0117 | ensayo off + replay==hot | AC5 |
